...
<html>
	...
	<div id="header">
			...
			<div id="banner">
				...
				<img src="images/kohlsstores.jpg" alt="" width="1180" height="300" />
			
			</div>
			
			<div id="nav">
					<ul>
				<li class="first"><a href="contactus.jsp">Contact us</a></li>
				<li class="first">
...
<h3 style="color: navy;" align="center"><B>Welcome to Kohl's Billing System</B></h3> 
<div id="box">
